...
2. We encourage you to use axios and implement interceptors to inject authorization headers in one place other than adding an authorization header for every call separately.
...
12. Display the latest (newest) 6 reviews on the home page. The most recent reviews added to your website.
